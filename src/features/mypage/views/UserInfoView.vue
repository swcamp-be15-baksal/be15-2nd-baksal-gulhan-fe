...
<template>
  <div class="container">
    ...
    <form class="info-form">
      <input type="text" class="no-edit" :value="isVerified ? userInfo.id : maskedInfo.id" readonly />
      <input type="text" class="no-edit" :value="isVerified ? userInfo.email : maskedInfo.email" readonly />
      ...
      <input type="text" :value="isVerified ? userInfo.address : maskedInfo.address" readonly />
    </form>

    <button class="edit-button" @click="router.push(`/mypage/user/${userInfo.id}/edit`)">회원 정보 수정</button>
