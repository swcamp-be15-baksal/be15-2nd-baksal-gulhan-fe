  ...
  <div class="container py-4">
    <div class="mb-4">
      ...
      <div v-if="product" class="d-flex align-items-start gap-3 mb-4">
        <div class="position-relative rounded overflow-hidden" style="width: 280px; height: 190px;">
          <img
            :src="product.image"
            alt="상품 이미지"
        ...
        <label for="file" class="d-inline-block" style="cursor: pointer;">
          ...
          >
            ...
            <button
              ...
              style="width: 28px; height: 28px; border-radius: 50%; background-color: rgba(0,0,0,0.6);"
